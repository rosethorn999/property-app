  ...
  return (
    <div>
      <h1 className="mb-4 text-xl font-bold">
        Privacy Policy for Property-STG
      </h1>

      <p>
        Property-STG is committed to protecting your privacy. This Privacy
      ...
      <p>
        ...
        own marketing purposes. We may share your personal information with
        third parties who provide services to us, such as web hosting and email
        marketing providers. These third parties are required to keep your
      ...
      <p>
        ...
        information. You also have the right to opt out of receiving marketing
        communications from us.
      </p>

      <p>
        To exercise your privacy choices, please contact us at admin@nodm.app
      </p>
      ...
      <p>
        ...
        provide you with our services or to comply with our legal obligations.
      </p>
      ...
      <p>
        <Link
          ...
          className="text-mayaBlue underline"
        >
          Privacy Policy
        </Link>{" "}
        and
