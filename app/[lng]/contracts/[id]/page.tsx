          ...
          <div className="upper-box mb-24 flex w-full flex-col gap-4 md:flex-row md:gap-24">
            <div className="left-box flex w-full flex-col gap-4 md:w-2/5">
              ...
              <div className="contacts-box flex flex-col gap-5">
                ...
                <div className="z-0 flex flex-wrap gap-2">
                  ...
                  <Link
                    href={`sms:+886${creator.mobile}&body=Ask from Property member`}
                    className={
                      creator.mobile
                        ? "pointer-events-auto"
                        : `pointer-events-none`
                  ...
                  <Link
                    href={`mailto:${creator.email}?subject=Ask from Property member`}
                    className={
                      creator.email
                        ? "pointer-events-auto"
                        : `pointer-events-none`
            ...
            <div className="right-box flex w-full flex-col gap-7 md:w-3/5">
              ...
              <div className="rounded-3xl">
                ...
                <div
                  className={`h-36 overflow-auto  text-sm ${
                    !description && "h-14"
                  }`}
                >
                  {description || `(${t("empty")})`}
