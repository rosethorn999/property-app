  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`hidden w-full flex-wrap gap-2 md:flex ${
            fitXs && "md:hidden"
          }`}
        >
          <FontAwesomeIcon
            icon={faLine}
            className={`text-3xl ${
              creator.line_id ? "cursor-pointer opacity-70" : "opacity-20"
            }`}
          ...
          <FontAwesomeIcon
            icon={faCommentSms}
            className={`text-3xl ${
              creator.mobile ? "cursor-pointer opacity-70" : "opacity-20"
            }`}
          ...
          <FontAwesomeIcon
            icon={faEnvelope}
            className={`text-3xl ${
              creator.email ? "cursor-pointer opacity-70" : "opacity-20"
            }`}
            title={creator.email}
          />
        </div> */}
      ...
      >
        <div
          className={`m-0 hidden w-full text-2xl md:block ${
            fitXs ? "hidden md:hidden" : ""
          }`}
        >
        ...
        {/* <div
          className={`w-full text-2xl md:text-slateGrey ${
            fitXs
              ...
              : "md:text-base md:text-slateGrey"
          }`}
        >
